...
function CardAd({ ad, favorites, setFavorites, user }) {
        ...
        <>
            <div id={ad.id} className={ad.highlighted ? "highlighted ad-card" : "ad-card"}>
                ...
                <div className="card-footer">
                    ...
                    <button className="card-btn card-favorite-btn" onClick={(e) => handleFavButtonClick(e, ad, favorites, setFavorites, user)}>
