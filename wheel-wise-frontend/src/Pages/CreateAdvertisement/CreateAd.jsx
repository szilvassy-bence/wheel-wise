  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        setFormData({
          ...formData,
          color: colorData[0].name,
          fuelType: fuelTypeData[0].name,
          transmission: transmissionTypeData[0].name,
        });
        setUser(userData);
      } catch (error) {
          ...
          <fieldset>
            ...
            <div className="control-group">
              <div className="control">
                <label className="ad-label" htmlFor="brand">
                  Brand
                </label>
                <select
                  name="brand"
              ...
              <div className="control">
                <label className="ad-label" htmlFor="model">
                  Model
                </label>
                {selectedBrand != null &&
              ...
              <div className="control">
                <label className="ad-label" htmlFor="color">
                  Color
                </label>
                <select
                  name="color"
                  ...
                  required
                >
                  {carProperties.colors.map((color) => (
              ...
              <div className="control">
                <label className="ad-label" htmlFor="fuelType">
                  Fuel Type
                </label>
                <select
                  name="fuelType"
                  ...
                  required
                >
                  {carProperties.fuelTypes.map((fuel) => (
              ...
              <div className="control">
                <label className="ad-label" htmlFor="transmission">
                  Transmission
                </label>
                <select
                  name="transmission"
                  ...
                  required
                >
                  {carProperties.transmissionTypes.map((tr) => (
              ...
              <div className="control">
                ...
                >
                  ...
                  <option key="1" value="Used">
                    Used
                  </option>
                  <option key="2" value="Broken">
                    Broken
                  </option>
                </select>
              </div>
              ...
              <div className="control">
                <label className="ad-label" htmlFor="year">
                  Year
                </label>
                <select
                  name="year"
              ...
              <div className="control">
                <label className="ad-label" htmlFor="price">
                  Price
                </label>
                <input
                  type="number"
              ...
              <div className="control">
                <label className="ad-label" htmlFor="mileage">
                  Mileage
                </label>
                <input
                  type="number"
              ...
              <div className="control">
                <label className="ad-label" htmlFor="power">
                  Power
                </label>
                <input
                  type="number"
